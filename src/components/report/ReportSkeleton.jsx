...
function SkeletonCard({ children, className = "" }) {
  return (
    <div className={`rounded-[--radius-button] border border-[--color-border] bg-white p-4 ${className}`}>
      {children}
    </div>
  );
}
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-5 xl:grid-cols-2">
        <SkeletonCard className="space-y-3">
          ...
          <div className="space-y-3">
            <div className="rounded-[--radius-button] bg-surface-100 p-3">
      ...
      <SkeletonCard className="space-y-3">
        ...
        <div className="space-y-3">
          {[0, 1, 2].map((item) => (
            <div key={item} className="rounded-[--radius-button] bg-surface-100 p-4">
              <SkeletonLine className="w-11/12" />
